                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-secondary" style="margin-right: 10px" data-bs-toggle="modal" v-bind:data-bs-target="'#update-bot-modal-' +bot.id">修改</button>
...
export default{
    ...
    setup(){
        ...
        const refresh_bots = () =>{
            $.ajax({
                url:"https://app7063.acapp.acwing.com.cn/api/user/bot/getlist/",
                type:"get",
                headers:{
        ...
        const add_bot =()=>{
            ...
            $.ajax({
                url:"https://app7063.acapp.acwing.com.cn/api/user/bot/add/",
                type:"post",
                data:{
                    title:botadd.title,
        ...
        const remove_bot =(bot)=>{
            $.ajax({
                url:"https://app7063.acapp.acwing.com.cn/api/bot/remove/",
                type:"post",
                data:{
                    bot_id:bot.id,
                },
        ...
        const update_bot =(bot)=>{
            botadd.error_message="";
            $.ajax({
                url:"https://app7063.acapp.acwing.com.cn/api/user/bot/update/",
                type:"post",
                data:{
                    bot_id:bot.id,
                    title:bot.title,
